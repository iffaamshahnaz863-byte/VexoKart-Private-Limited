        ...
        <div className="bg-surface min-h-screen">
            ...
            <article className="max-w-4xl mx-auto p-6 md:p-12 bg-white mt-10 rounded-[3rem] shadow-premium mb-20">
                <header className="mb-10">
                    ...
                    <h1 className="text-4xl font-black text-gray-900 italic uppercase tracking-tight mt-4 leading-none">How VexoKart Ensures<br/><span className="text-accent">Authentic Quality</span></h1>
                ...
                <div className="prose prose-lg text-gray-600 leading-relaxed space-y-8">
                    <p className="text-xl font-medium text-gray-800">Quality isn't accidental—it's a product of rigorous systems. At VexoKart, we've pioneered the **VexoShield Manifest**, a multi-tier verification process designed to filter out sub-standard inventory.</p>
                    
                    <section>
                        <h2 className="text-2xl font-black text-gray-900 uppercase italic mb-4">Tier 1: Vendor Sourcing Audit</h2>
                        <p>We don't accept everyone. Vendors wishing to join the VexoKart ecosystem must provide verifiable proof of authorization from brands or manufacturers. This initial gate ensures that the products enter our digital ecosystem through legitimate, legal channels.</p>
                    </section>
