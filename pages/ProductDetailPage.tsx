  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] pb-32 font-sans select-none overflow-x-hidden">
      ...
      <div className="bg-white p-4 space-y-3 shadow-sm">
        ...
        {/* Real UPI Discount Block */}
        {upiSavings > 0 && (
            <div className="flex items-center gap-2">
              <div className="bg-[#E7F7F0] text-[#34BE82] text-[10px] font-bold px-2 py-1 rounded flex items-center gap-1 border border-[#C2EAD5]">
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" /></svg>
                ₹{upiPrice} with UPI
              </div>
              <span className="text-[10px] font-bold text-gray-400 line-through">₹{sellingPrice}</span>
            </div>
        )}

        <div className="flex items-center gap-2">
          <div className="bg-[#34BE82] text-white text-[10px] font-bold px-2 py-1 rounded flex items-center gap-1">
            {product.rating || '4.0'} <svg className="w-2 h-2" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
          </div>
