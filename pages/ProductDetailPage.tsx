      ...
      <div className="px-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2 py-1">
            {product.allow_online && (
                <span className="flex items-center gap-1 text-[9px] font-black uppercase tracking-tighter bg-green-50 text-green-600 px-2 py-1 rounded-md border border-green-100">
                    <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                    Online Payment
                </span>
            )}
            {product.allow_cod && (
                <span className="flex items-center gap-1 text-[9px] font-black uppercase tracking-tighter bg-orange-50 text-orange-600 px-2 py-1 rounded-md border border-orange-100">
                    <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                    COD Available
                </span>
            )}
        </div>
