...
const InvoiceModal: React.FC<InvoiceModalProps> = ({ order, onClose }) => {
  ...
  const primarySeller = order.seller_name || order.items[0]?.vendor_name || 'DAR CYCLE HUB Authorized Vendor';
            ...
            {pdfUrl ? (
                ...
                <>
                    ...
                    <div className="mt-16 text-center pb-10">
                        <p className="text-[8px] font-black uppercase tracking-[0.4em] text-gray-300">Generated by DAR CYCLE HUB Fulfillment Protocol</p>
                    </div>
                </>
            )}
        </div>
