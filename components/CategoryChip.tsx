...
const CategoryChip: React.FC<CategoryChipProps> = ({ category, isSelected = false, onClick }) => {
  ...
  const selectedClasses = "bg-gradient-to-br from-purple-600 to-blue-600 shadow-lg";
  ...
  return (
    ...
    >
      <img src={category.image} alt={category.name} className="w-16 h-16 object-cover rounded-full mx-auto mb-2 border-2 border-purple-500/50" />
