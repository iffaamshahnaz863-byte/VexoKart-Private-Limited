  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-[68px] bg-white border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.03)] z-50 px-2">
      <div className="flex justify-around items-center h-full max-w-lg mx-auto">
        <NavItem to="/" label="Home" icon={<HomeIcon className="h-5 w-5" />} />
        
        <NavItem to="/products" label="Categories" icon={<CategoryIcon className="h-5 w-5" />} />
        
        <NavItem to="/mall" label="Mall" icon={
